    ...
    <input type="text" name="submit_id" class="form-control" id="submit_id" placeholder="ID" value="<?php echo $row['id'] ?>" hidden>
            ...
            <div class="form-group col-md-4">
                ...
                <?php else: ?>
                    <select id="inputType" name="tipo" class="form-control" required>
                        <option value="0">Cliente (Pessoa Física)</option>
        ...
        <fieldset id="fieldsetFuncionario" hidden>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="salario" class="form-control" id="inputSalario" placeholder="xxxx,xx"  maxlength="9" value="<?php echo $row['salario_funcionario'] ?>">
            </div>
            <div class="form-group col-md-4">
