...
<?php
	...
	<table class ="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>    
                <td class="td-userlist">Preço:</td><td>R$ <?php echo $row['preco'];?></td>
            </tr>
            <tr>
                <td class="td-userlist">Desconto:</td><td>R$ <?php echo $row['desconto'];?></td>
            </tr>
            <tr>    
                <td class="td-userlist">Preço Promocional:</td><td>R$ <?php $preco = $row['preco']-$row['desconto']; echo number_format($preco,2,".","");?></td>
            </tr>
            <tr>
